...
class HuggingFace {
    ...
    json_data_predict_api_fn_index2 = { "data": [null, [[this.question, ""]], "You are a helpful, respectful and honest assistant with a deep knowledge of code and software design. Always answer as helpfully as possible, while being safe. Your answers should not include any harmful, unethical, racist, sexist, toxic, dangerous, or illegal content. Please ensure that your responses are socially unbiased and positive in nature.\n\nIf a question does not make any sense, or is not factually coherent, explain why instead of answering something not correct. If you don't know the answer to a question, please don't share false information."], "event_data": null, "fn_index": this.fn_index[2], "session_hash": this.session_hash };

    // wb payload
    json_data_wb_send_hash = { "fn_index": this.fn_index[3], "session_hash": this.session_hash };

    json_data_wb_send_data = { "data": [null, [[this.question, ""]], "You are a helpful, respectful and honest assistant with a deep knowledge of code and software design. Always answer as helpfully as possible, while being safe. Your answers should not include any harmful, unethical, racist, sexist, toxic, dangerous, or illegal content. Please ensure that your responses are socially unbiased and positive in nature.\n\nIf a question does not make any sense, or is not factually coherent, explain why instead of answering something not correct. If you don't know the answer to a question, please don't share false information.", 1024, 0.1, 0.9, 10], "event_data": null, "fn_index": this.fn_index[3], "session_hash": this.session_hash };
    /////////////
